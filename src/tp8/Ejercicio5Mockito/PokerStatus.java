...
public class PokerStatus {
	...
	private Boolean hayPokerDe(Carta unaCarta, ArrayList<Carta> mano) {
		...
		return mano.stream().filter(carta -> carta.getValorNumerico().equals(unaCarta.getValorNumerico())).count() == 4;
	}
	...
	private boolean hayTrioDe(Carta unaCarta, ArrayList<Carta> mano) {
		...
		return mano.stream().filter(carta -> carta.getValorNumerico().equals(unaCarta.getValorNumerico())).count() == 3;
